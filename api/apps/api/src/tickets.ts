...
const TICKET_COLS = `t.id, t.subject, t.status, t.channel_type, t.external_channel_id,
              ...
              (SELECT sb.subject FROM broadcasts sb
                 WHERE sb.tenant_id = t.tenant_id AND sb.id = t.source_broadcast_id) AS source_broadcast_subject,
              ...
              t.contact_id, co.name AS contact_name, co.email AS contact_email, co.avatar_url AS contact_avatar_url,
