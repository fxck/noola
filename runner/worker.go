...
func main() {
	...
	// The flow-runner image is baked into the runtime image at deploy (run.prepareCommands) as a
	// local tag, so a registry `pull` will usually miss — that's fine. Report whether the tag is
	// present.
	go func() {
